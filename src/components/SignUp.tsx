...
export default function SignUp({
  ...
  return (
    <>
      ...
      >
        <source
          src="/assets/bg-vids/sign-up.webm"
          type="video/webm"
        />
        <source
          src="/assets/bg-vids/sign-up.mp4"
          type="video/mp4"
        />
      </video>
        ...
        >
          <div className="first-name-field flex flex-col py-[1%] text-base uppercase tracking-wide xl:text-lg 2xl:text-lg">
            ...
            <input
              ...
              {...register('firstName')}
              className="input-ring-white input focus-ring-white appearance-none!important rounded-sm p-2 font-grotesque text-xs font-medium text-charcoal placeholder:text-xs placeholder:text-charcoal focus:outline-none  focus:outline-2 focus:outline-offset-0 focus:outline-white md:h-9 lg:h-10 lg:text-base xl:h-11  2xl:h-12 portrait:mb-2 portrait:text-[1rem] portrait:placeholder:text-sm portrait:md:py-5 portrait:md:text-lg portrait:md:placeholder:text-lg"
            ></input>
          ...
          <div className="last-name-field flex flex-col py-[1%] text-base uppercase tracking-wide xl:text-lg  2xl:text-lg">
            ...
            <input
              ...
              {...register('lastName')}
              className="input-ring-white input focus-ring-white rounded-sm p-2  font-grotesque text-xs font-medium text-charcoal placeholder:text-xs placeholder:text-charcoal md:h-9 lg:h-10 lg:text-base xl:h-11 2xl:h-12 portrait:mb-2 portrait:text-[1rem] portrait:placeholder:text-sm portrait:md:py-5 portrait:md:text-lg portrait:md:placeholder:text-lg"
            ></input>
          ...
          <div className="password-field flex flex-col py-[1%] text-base uppercase tracking-wide xl:text-lg 2xl:text-lg">
            ...
            <input
              ...
              {...register('password')}
              className="input-ring-white  focus-ring-white rounded-sm p-2  font-grotesque text-xs font-medium text-charcoal placeholder:text-xs placeholder:text-charcoal md:h-9 lg:h-10 lg:text-base xl:h-11 2xl:h-12 portrait:mb-2 portrait:text-[1rem] portrait:placeholder:text-sm portrait:md:py-5 portrait:md:text-lg portrait:md:placeholder:text-lg"
            ></input>
