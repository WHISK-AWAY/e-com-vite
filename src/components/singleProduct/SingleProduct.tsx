      ...
      >
        astoria
            ...
            <main
                ...
                } single-product-main mx-auto mb-40 flex min-h-[calc(100vh_-_4rem)]  flex-col items-center   xl:mt-14 2xl:max-w-[1420px] portrait:md:px-5 portrait:lg:max-w-[95svw]`}
            >
                <section
                    ref={prodInfoWrapper}
                    className={` ${
                ...
                add to cart
                        ...
                        >
                            ...
                            <p className="text-center font-grotesque text-xs font-light lg:text-sm xl:text-base portrait:md:text-[1.2rem] portrait:md:leading-6 portrait:lg:text-[1.8rem] portrait:lg:leading-7">
                                ...
                                to quickly fight the look of dullness, dark
                                spots, and discolorations at the source, while
                                diminishing the signs of premature aging. Skin
                                looks firmer and plumper, as youthful skin
                                bounce and even-tone are restored. CEO 15%
                                Vitamin C Brightening Serum, uses a
                                sophisticated, ultra-powerful form of Vitamin C
                                called THD Ascorbate. Both highly stable and
                                oil-soluble, THD Ascorbate rapidly absorbs into
                                the skin for visible anti-aging benefits,
                                including visual improvement in loss of
                                firmness, the appearance of lines and wrinkles,
                                and dark spots and dullness. This hydrating
                                antioxidant formula instantly illuminates the
                                complexion with bright radiance, while
                                phytosterols help to reduce the signs of skin
                                sensitivity. Saccharide Isomerate extract
                                diminishes the appearance of pores and
                                reinforces the skin’s moisture barrier for a
                                skin-smoothing glow. Rapidly brighten the
                                appearance of the skin and boost vital skin
                                bounce, in a flash!
                            </p>
                        </div>
                    </section>
