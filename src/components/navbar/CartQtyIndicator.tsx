    ...
    <section className="relative">
      {cartItemsQty > 0 && (
        <div
          ...
          } absolute top-3 flex aspect-square -translate-y-1/2 items-center justify-center rounded-full bg-primary-gray font-grotesque  leading-[0] text-white lg:right-[.5] lg:top-4 lg:w-[1rem] lg:text-[.7rem] 3xl:w-[1.2rem] 3xl:pb-1 3xl:text-[.8rem] portrait:md:text-[.8rem] portrait:md:w-[1.2rem] portrait:md:top-5 portrait:md:right-[.1rem]`}
        >
          {cartItemsQty}
        </div>
      )}
