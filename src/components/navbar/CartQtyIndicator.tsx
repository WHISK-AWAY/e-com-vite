    ...
    <section className="relative">
      {cartItemsQty > 0 && (
        <div
          ...
          className="absolute right-0 top-3 z-0 flex aspect-square w-[.8rem] -translate-y-1/2 items-center justify-center rounded-full bg-primary-gray font-grotesque text-[.5rem] leading-[0] text-white lg:right-[.5] lg:top-4 lg:w-[1rem] lg:text-[.7rem] 3xl:w-[1.2rem] 3xl:pb-1 3xl:text-[.8rem]"
        >
          {cartItemsQty}
        </div>
      )}
