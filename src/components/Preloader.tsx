...
// vidRef.play()
  ...
  return (
    <div className='pre-loader clipper-container relative z-[100000]'>
      ...
      <div className='vid-layout h-screen w-screen bg-white flex  justify-center'>
        <video ref={vidRef} src={`${vidLoader}#t=7`} muted={true} autoPlay={true} className='vid w-96 aspect-[5/6] poly-clip poly-clip  object-cover'></video>
         {/* <video ref={vidRef} src={`${vidLoader}#t=7`} muted={true} autoPlay={true} className='vid w-96 aspect-[5/6] poly-clip object-cover'></video> */}
        {/* <video ref={vidRef} src={`${vidLoader}#t=7`} muted={true} autoPlay={true} className='vid w-96 aspect-[5/6] poly-clip object-cover'></video> */} 
       <p className="slogan flex flex-col justify-start items-start text-[2vw] font-marcellus absolute top-[30%] left-[1/2] 5xl:left-[30%] uppercase">glow gifted by <span className='font-aurora  lowercase self-center  '>nature</span></p>
